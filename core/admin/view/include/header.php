        ...
        <div class="wq-wrapper">
            ...
            <header class="wq-header">
                ...
                <div style="display: none; width: 100vw; height: 100vh; top: 0; left: 0; position: fixed; background: rgba(0,0,0,0.8); z-index: 999; justify-content: center; align-items: center; padding: 20px" class="import-form">
                    <form action="<?=$this->adminPath?>import" method="post" enctype="multipart/form-data" style="flex-basis: 600px; background: white; padding: 20px">
                        <label for="">
                            <span>Файл импорта</span>
                            <input type="file" multiple name="import[]" accept="audio/mpeg" style="display: block; margin: 10px 0">
                        </label>
                        <label for="">
                            <span>Исполнитель</span>
                            <input type="text"  name="artist[]" style="display: block; margin: 10px 0; border: 1px solid">
                            <input type="checkbox" value="artist" name="artist[]" style="display: block; margin: 10px 0">
                        </label>
                        <label for="">
                            <span>Выбор стиля</span>
                            <input type="text"  name="style[]" style="display: block; margin: 10px 0; border: 1px solid">
                            <input type="checkbox" value="style" name="style[]" style="display: block; margin: 10px 0">
                        </label>
                        <input type="submit" value="Загрузить" style="display: inline-block; margin: auto">
                    </form>
                </div>
